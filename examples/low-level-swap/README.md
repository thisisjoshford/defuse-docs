...
The protocol abstracts execution details, making it easier for developers and users to engage in decentralized finance (DeFi) operations seamlessly. For more in-depth details about the architecture behind NEAR Intents and the multichain bridge OmniBridge, visit the official NEAR documentation.

### What You Will Learn

In this tutorial, you will learn how to:

* [**Deposit tokens**](step-1-deposit.md) from different chains (NEAR, EVM-compatible, Solana)
